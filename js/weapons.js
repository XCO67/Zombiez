...
const WEAPONS = {
  ...
  lasergun:     { name:'Lasergun',     fireRate:1,  baseDmg:80,    ammoMax:8,        pellets:1,  spread:0,    speed:0,  hitR:0,   pierce:true,  color:'#ff00cc', trail:'#ff00ff', laser:true, ammoCost:200 },
  xenoblaster:  { name:'Xenoblaster',  fireRate:24, baseDmg:68,    ammoMax:12,       pellets:1,  spread:0,    speed:8,  hitR:0.55,pierce:true,  color:'#00ffcc', trail:'#44ffaa', alien:true, ammoCost:175 },
