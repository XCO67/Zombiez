...
const FAKE_LB = [
  // kills formula: ~1.4*R² + 4*R (cumulative wave zombies), ±10% natural variance
  ['mikeyd97',     42, 2722, 422700, 38800, '2026-03-08'],
  ['ChrisVortex',  38, 2199, 308000, 30630, '2026-03-04'],
  ['VoidSlayer',   35, 1860, 251600, 25900, '2026-03-11'],
  ['jake_irl',     33, 1645, 197800, 21570, '2026-03-01'],
  ['ethanrr',      27, 1161, 123900, 15500, '2026-03-07'],
  ['NovaSurge',    25,  961,  94000, 12800, '2026-03-09'],
  ['liam_online',  24,  893,  78000, 10460, '2026-02-27'],
  ['OliverPlays',  22,  762,  71800, 10050, '2026-03-01'],
  ['ZachAttack22', 21,  700,  65000,  9300, '2026-03-05'],
  ['nathan_x99',   19,  576,  35900,  5590, '2026-02-19'],
  ['Khalid_FPS',   16,  413,  27400,  4650, '2026-02-24'],
  ['RexRunner',    15,  370,  23800,  4100, '2026-03-02'],
  ['harrygg',      13,  284,  12500,  2390, '2026-02-16'],
  ['sam_wrecks',   11,  208,   8900,  1860, '2026-02-21'],
  ['TomFPS',       10,  176,   6200,  1360, '2026-02-08'],
  ['MaxDiesel',     9,  144,   5800,  1350, '2026-02-13'],
  ['FinnPlays',     9,  138,   5200,  1200, '2026-03-06'],
  ['dylan_v2',      9,  127,   4800,  1110, '2026-02-02'],
  ['callumrr',      8,  116,   4400,  1070, '2026-02-10'],
  ['JamieOnFire',   7,   90,   3200,   830, '2026-01-31'],
  ['xKarim_fps',    7,   87,   3000,   800, '2026-03-10'],
  ['Ahmad_gg',      7,   81,   2800,   740, '2026-01-26'],
  ['scottygaming',  6,   75,   2500,   680, '2026-01-19'],
  ['ryanx_plays',   6,   69,   2000,   560, '2026-02-05'],
  ...
  ['AlexTV',        4,   36,    800,   290, '2025-12-28'],
  ...
  ['GioGaming',     2,   15,    320,   140, '2026-03-08'],
  ['TylerWave',     2,   13,    270,   120, '2026-03-06'],
  ...
  ['EliteGhost',    1,    8,    110,    70, '2026-03-07'],
  ['DanteXP',       1,    6,     90,    55, '2026-03-09'],
  ['NightCrawlerZ', 1,    7,    100,    60, '2026-03-10'],
